...
public class PendaftaranMahasiswa {
    ...
    public static void main(String[] args) {
        ...
        // Input nilai UN
        System.out.print("Masukan Nilai UN\t\t: ");
        ...
        System.out.println("===================================================");
        System.out.println("Nama\t\t\t : " + mahasiswa.nama_lengkap);
        ...
        System.out.println("Handphone\t\t : " + mahasiswa.handphone);
        System.out.println("Nilai UN\t\t : " + mahasiswa.nilaiUN);
        System.out.println("===================================================");
        System.out.println("Selamat dan Terima Kasih Telah Melakukan Registrasi");
        System.out.println("===================================================");
    }
}
